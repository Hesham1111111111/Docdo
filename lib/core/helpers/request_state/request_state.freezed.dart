...
class InitialState<T> implements RequestState<T> {
  const InitialState();
...
class LoadingState<T> implements RequestState<T> {
  const LoadingState();
...
/// @nodoc
abstract mixin class $SuccessStateCopyWith<T,$Res> implements $RequestStateCopyWith<T, $Res> {
...
class ErrorState<T> implements RequestState<T> {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ErrorState<T>&&(identical(other.message, message) || other.message == message));
}
...
/// @nodoc
abstract mixin class $ErrorStateCopyWith<T,$Res> implements $RequestStateCopyWith<T, $Res> {
